...
#-march=armv7ve+simd
DEFS = -DLINUX -DNDEBUG -DMIYOO -fpermissive -DFT2_BUILD_LIBRARY=1
#-DUSE_SDL_RENDERER  
#-DMIYOO, search SDL_RenderPresent in ONScripter.cpp, there is a display flush bug for SDL2
INCS = -Os $(ARCH) -I${SYSROOT}/usr/include -I${SYSROOT}/usr/include/SDL  -I./freetype-2.3.5_mod/include -I./bzip2-1.0.4_mod -ffunction-sections -fdata-sections -Wall -I./jpeg-6b_mod

LIBS = -L${SYSROOT}/usr/lib $(ARCH) -lSDL_ttf  -lSDL_mixer -lSDL -lpng -lz -lpthread -lm
#-lSDL_image
#removed -lSDL2_image
#-L${SYSROOT}/usr/lib 
EXT_FLAGS =
else
DEFS = -DLINUX -DMIYOO -g3 -O0 -DFREETYPE_HDR_DIRECTORY -fpermissive -DFT2_BUILD_LIBRARY=1
INCS = -I./SDL_ttf-2.0.9_mod -I./jpeg-6b_mod `sdl-config --cflags` -I./freetype-2.3.5_mod/include
LIBS = `sdl-config --libs` -lSDL_mixer -lpng -lz -lm
